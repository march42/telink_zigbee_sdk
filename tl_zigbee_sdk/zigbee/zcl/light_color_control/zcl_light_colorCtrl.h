...
#define ZCL_COLOR_ATTR_TEMPERATURE_MIREDS_UNDEFINED				0x0000
#define ZCL_COLOR_ATTR_TEMPERATURE_MIREDS_MIN					1
#define ZCL_COLOR_ATTR_TEMPERATURE_MIREDS_MAX					0xFEFF
#define ZCL_COLOR_ATTR_TEMPERATURE_MIREDS_INVALID				0xFFFF
